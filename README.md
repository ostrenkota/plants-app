...
# Create VK Mini AppModule [![npm][npm]][npm-url] [![deps][deps]][deps-url]

## How to install

### Create VK Mini AppModule with gh-pages deploy

`npx @vkontakte/create-vk-mini-app <app-directory-name>`

### Create VK Mini AppModule with Zeit deploy
...
### Create VK Mini AppModule with Surge deploy
